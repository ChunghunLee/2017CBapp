...
public class zzo {
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0286R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
    ...
    L_0x0006:
        r2 = com.google.android.gms.internal.zzbgz.zzaP(r7);	 Catch:{ NameNotFoundException -> 0x0041 }
