...
public final class zza extends com.google.android.gms.common.internal.safeparcel.zza implements AutocompletePrediction {
    ...
    public final boolean equals(Object obj) {
        ...
        return zzbe.equal(this.zzbjI, com_google_android_gms_location_places_internal_zza.zzbjI) && zzbe.equal(this.zzbjj, com_google_android_gms_location_places_internal_zza.zzbjj) && zzbe.equal(Integer.valueOf(this.zzbke), Integer.valueOf(com_google_android_gms_location_places_internal_zza.zzbke)) && zzbe.equal(this.zzbkc, com_google_android_gms_location_places_internal_zza.zzbkc) && zzbe.equal(this.zzbkd, com_google_android_gms_location_places_internal_zza.zzbkd) && zzbe.equal(this.zzbkf, com_google_android_gms_location_places_internal_zza.zzbkf) && zzbe.equal(this.zzbkg, com_google_android_gms_location_places_internal_zza.zzbkg) && zzbe.equal(this.zzbkh, com_google_android_gms_location_places_internal_zza.zzbkh) && zzbe.equal(this.zzbki, com_google_android_gms_location_places_internal_zza.zzbki);
    }
