...
public final class zzaj extends zza {
    ...
    public final boolean equals(Object obj) {
        ...
        zzaj com_google_android_gms_location_places_internal_zzaj = (zzaj) obj;
        return zzbe.equal(this.name, com_google_android_gms_location_places_internal_zzaj.name) && zzbe.equal(this.address, com_google_android_gms_location_places_internal_zzaj.address) && zzbe.equal(this.zzbkK, com_google_android_gms_location_places_internal_zzaj.zzbkK) && zzbe.equal(this.zzbkL, com_google_android_gms_location_places_internal_zzaj.zzbkL) && zzbe.equal(this.zzbkM, com_google_android_gms_location_places_internal_zzaj.zzbkM);
    }
