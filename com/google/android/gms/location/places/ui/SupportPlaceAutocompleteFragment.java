...
public class SupportPlaceAutocompleteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        OnClickListener com_google_android_gms_location_places_ui_zze = new zze(this);
        this.zzblm.setOnClickListener(com_google_android_gms_location_places_ui_zze);
        this.zzblo.setOnClickListener(com_google_android_gms_location_places_ui_zze);
