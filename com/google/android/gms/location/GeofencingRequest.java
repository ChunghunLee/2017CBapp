...
public class GeofencingRequest extends zza {
    ...
    private final List<zzcdq> zzbhQ;
    private final int zzbhR;

    public static final class Builder {
        private String mTag = "";
        private final List<zzcdq> zzbhQ = new ArrayList();
        private int zzbhR = 5;

        public final Builder addGeofence(Geofence geofence) {
            zzbo.zzb((Object) geofence, (Object) "geofence can't be null.");
            zzbo.zzb(geofence instanceof zzcdq, (Object) "Geofence must be created using Geofence.Builder.");
            this.zzbhQ.add((zzcdq) geofence);
            return this;
        }
    ...
    GeofencingRequest(List<zzcdq> list, int i, String str) {
        this.zzbhQ = list;
        this.zzbhR = i;
        this.mTag = str;
    }
