...
public final class zzbff extends Drawable implements Callback {
    ...
    public zzbff(Drawable drawable, Drawable drawable2) {
        this(null);
        if (drawable == null) {
            drawable = zzbfh.zzaGB;
        }
        this.zzaGv = drawable;
        drawable.setCallback(this);
        zzbfj com_google_android_gms_internal_zzbfj = this.zzaGu;
        com_google_android_gms_internal_zzbfj.zzaGD |= drawable.getChangingConfigurations();
        if (drawable2 == null) {
            drawable2 = zzbfh.zzaGB;
        }
        this.zzaGw = drawable2;
        drawable2.setCallback(this);
        com_google_android_gms_internal_zzbfj = this.zzaGu;
        com_google_android_gms_internal_zzbfj.zzaGD |= drawable2.getChangingConfigurations();
    }
    ...
    zzbff(zzbfj com_google_android_gms_internal_zzbfj) {
        ...
        this.zzaGs = 0;
        this.zzaGj = true;
        this.zzaGu = new zzbfj(com_google_android_gms_internal_zzbfj);
    }
