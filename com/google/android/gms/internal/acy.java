...
public final class acy {
    ...
    public static int zzb(int i, adg com_google_android_gms_internal_adg) {
        int zzct = zzct(i);
        int zzLT = com_google_android_gms_internal_adg.zzLT();
    ...
    public final void zza(int i, adg com_google_android_gms_internal_adg) throws IOException {
        zzt(i, 2);
        zzb(com_google_android_gms_internal_adg);
    }
    ...
    public final void zzb(adg com_google_android_gms_internal_adg) throws IOException {
        zzcu(com_google_android_gms_internal_adg.zzLS());
    ...
    public final void zzl(int i, String str) throws IOException {
        ...
        try {
            ...
            acz com_google_android_gms_internal_acz = new acz(this.zzcrY.position(), this.zzcrY.limit());
            com_google_android_gms_internal_acz.initCause(e);
            throw com_google_android_gms_internal_acz;
        }
    }
