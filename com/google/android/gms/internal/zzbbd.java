...
public abstract class zzbbd<R extends Result> extends PendingResult<R> {
    ...
    private final R get() {
        ...
        zzbew com_google_android_gms_internal_zzbew = (zzbew) this.zzaCb.getAndSet(null);
        if (com_google_android_gms_internal_zzbew != null) {
            com_google_android_gms_internal_zzbew.zzc(this);
        }
        return r;
    }
    ...
    public final void zza(zzbew com_google_android_gms_internal_zzbew) {
        this.zzaCb.set(com_google_android_gms_internal_zzbew);
    }
