...
public final class zzbco extends GoogleApiClient implements zzbdp {
    ...
    public zzbco(Context context, Lock lock, Looper looper, zzq com_google_android_gms_common_internal_zzq, GoogleApiAvailability googleApiAvailability, zza<? extends zzctj, zzctk> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzctj__com_google_android_gms_internal_zzctk, Map<Api<?>, Boolean> map, List<ConnectionCallbacks> list, List<OnConnectionFailedListener> list2, Map<zzc<?>, zze> map2, int i, int i2, ArrayList<zzbbh> arrayList, boolean z) {
    ...
    private final void zza(GoogleApiClient googleApiClient, zzbem com_google_android_gms_internal_zzbem, boolean z) {
        zzbfn.zzaIy.zzd(googleApiClient).setResultCallback(new zzbcs(this, com_google_android_gms_internal_zzbem, z, googleApiClient));
    }
    ...
    public final PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        PendingResult com_google_android_gms_internal_zzbem = new zzbem((GoogleApiClient) this);
        if (this.zzaDF.containsKey(zzbfn.zzajR)) {
            zza(this, com_google_android_gms_internal_zzbem, false);
        } else {
            AtomicReference atomicReference = new AtomicReference();
            GoogleApiClient build = new Builder(this.mContext).addApi(zzbfn.API).addConnectionCallbacks(new zzbcq(this, atomicReference, com_google_android_gms_internal_zzbem)).addOnConnectionFailedListener(new zzbcr(this, com_google_android_gms_internal_zzbem)).setHandler(this.zzaDD).build();
    ...
    public final void disconnect() {
        ...
        try {
            ...
            this.zzaDH.release();
            for (zzbax com_google_android_gms_internal_zzbax : this.zzaCJ) {
    ...
    public final void stopAutoManage(@NonNull FragmentActivity fragmentActivity) {
        ...
        if (this.zzaBb >= 0) {
            zzbat.zza(com_google_android_gms_internal_zzbdq).zzal(this.zzaBb);
            return;
        }
    ...
    public final void zza(zzber com_google_android_gms_internal_zzber) {
        ...
        try {
            ...
            this.zzaDK.add(com_google_android_gms_internal_zzber);
        } finally {
            this.zzaCv.unlock();
        }
    }
    ...
    public final boolean zza(zzbeh com_google_android_gms_internal_zzbeh) {
        return this.zzaDz != null && this.zzaDz.zza(com_google_android_gms_internal_zzbeh);
    }
    ...
    public final void zzb(zzber com_google_android_gms_internal_zzber) {
        ...
        try {
            ...
            } else if (!this.zzaDK.remove(com_google_android_gms_internal_zzber)) {
        ...
        try {
            ...
            if (this.zzaDA) {
                ...
                while (!this.zzaCJ.isEmpty()) {
                    ...
                    this.zzaDL.zzb(com_google_android_gms_internal_zzbax);
                    com_google_android_gms_internal_zzbax.zzr(Status.zzaBo);
                }
            } else {
                t = this.zzaDz.zze(t);
                this.zzaCv.unlock();
    ...
    public final void zze(int i, boolean z) {
        if (!(i != 1 || z || this.zzaDA)) {
            this.zzaDA = true;
            if (this.zzaDE == null) {
                this.zzaDE = GoogleApiAvailability.zza(this.mContext.getApplicationContext(), new zzbcu(this));
            }
    ...
    public final <L> zzbdv<L> zzp(@NonNull L l) {
        this.zzaCv.lock();
        try {
            zzbdv<L> zza = this.zzaDH.zza(l, this.zzrO, "NO_TYPE");
            return zza;
        } finally {
            this.zzaCv.unlock();
        }
