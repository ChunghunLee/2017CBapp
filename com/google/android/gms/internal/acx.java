...
public final class acx {
    ...
    public final int zzLD() throws IOException {
        ...
        int i = zzLJ & TransportMediator.KEYCODE_MEDIA_PAUSE;
        byte zzLJ2 = zzLJ();
        if (zzLJ2 >= (byte) 0) {
            return i | (zzLJ2 << 7);
        }
        i |= (zzLJ2 & TransportMediator.KEYCODE_MEDIA_PAUSE) << 7;
        zzLJ2 = zzLJ();
        if (zzLJ2 >= (byte) 0) {
            return i | (zzLJ2 << 14);
        }
        i |= (zzLJ2 & TransportMediator.KEYCODE_MEDIA_PAUSE) << 14;
        zzLJ2 = zzLJ();
        if (zzLJ2 >= (byte) 0) {
            return i | (zzLJ2 << 21);
        }
        i |= (zzLJ2 & TransportMediator.KEYCODE_MEDIA_PAUSE) << 21;
        zzLJ2 = zzLJ();
        i |= zzLJ2 << 28;
        if (zzLJ2 >= (byte) 0) {
            return i;
    ...
    public final long zzLE() throws IOException {
        ...
        for (int i = 0; i < 64; i += 7) {
            byte zzLJ = zzLJ();
            j |= ((long) (zzLJ & TransportMediator.KEYCODE_MEDIA_PAUSE)) << i;
            if ((zzLJ & 128) == 0) {
                return j;
            }
        }
