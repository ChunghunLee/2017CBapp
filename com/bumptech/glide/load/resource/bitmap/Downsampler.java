...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    public static final Downsampler AT_LEAST = new C04511();
    public static final Downsampler AT_MOST = new C04522();
    private static final int MARK_POSITION = 5242880;
    public static final Downsampler NONE = new C04533();
    ...
    static class C04511 extends Downsampler {
        C04511() {
        }
    ...
    static class C04522 extends Downsampler {
        C04522() {
        }
    ...
    static class C04533 extends Downsampler {
        C04533() {
        }
