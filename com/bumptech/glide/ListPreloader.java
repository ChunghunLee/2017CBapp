...
public class ListPreloader<T> implements OnScrollListener {
    ...
    class C04081 implements PreloadModelProvider<T> {
        C04081() {
        }
    ...
    class C04092 implements PreloadSizeProvider<T> {
        C04092() {
        }
    ...
    public ListPreloader(int maxPreload) {
        ...
        this.preloadModelProvider = new C04081();
        this.preloadDimensionProvider = new C04092();
