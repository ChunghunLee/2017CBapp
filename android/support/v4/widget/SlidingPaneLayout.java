...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03701());
        boolean isOpen;

        static class C03701 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03701() {
            }
