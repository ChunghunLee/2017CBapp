...
public class MediaSessionCompat {
    ...
    class C03461 extends Callback {
        C03461() {
        }
    }

    class C03472 extends Callback {
        C03472() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C03481();
        ...
        class C03481 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C03481() {
            }
        ...
        class C04342 implements Callback {
            C04342() {
            }
