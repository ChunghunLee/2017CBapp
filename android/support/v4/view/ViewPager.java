...
public class ViewPager extends ViewGroup {
    ...
    class C03594 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03601());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C03601 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03601() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03594());
    }
