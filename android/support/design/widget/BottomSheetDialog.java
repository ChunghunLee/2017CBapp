...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C03092 extends AccessibilityDelegateCompat {
        C03092() {
        }
    ...
    class C03103 extends BottomSheetCallback {
        C03103() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C03103();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        ...
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C03092());
        return coordinator;
    }
