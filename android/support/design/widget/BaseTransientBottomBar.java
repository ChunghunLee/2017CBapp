...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    final Callback mManagerCallback = new C03013();
    ...
    class C03002 implements OnApplyWindowInsetsListener {
        C03002() {
        }
    ...
    class C03013 implements Callback {
        C03013() {
        }
    ...
    class C03024 implements OnDismissListener {
        C03024() {
        }
    ...
    class C03035 implements OnAttachStateChangeListener {
    ...
    class C03046 implements OnLayoutChangeListener {
        C03046() {
        }
    ...
    class C04237 extends ViewPropertyAnimatorListenerAdapter {
        C04237() {
        }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content, @NonNull ContentViewCallback contentViewCallback) {
        if (parent == null) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.mView, new C03002());
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (lp instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new C03024());
                clp.setBehavior(behavior);
                clp.insetEdge = 80;
            }
            this.mTargetParent.addView(this.mView);
        }
        this.mView.setOnAttachStateChangeListener(new C03035());
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new C03046());
    ...
    void animateViewIn() {
        if (VERSION.SDK_INT >= 14) {
            ...
            ViewCompat.animate(this.mView).translationY(0.0f).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setDuration(250).setListener(new C04237()).start();
            return;
        }
