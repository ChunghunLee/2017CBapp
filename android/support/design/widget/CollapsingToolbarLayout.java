...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C03121 implements OnApplyWindowInsetsListener {
        C03121() {
        }
    ...
    class C03132 implements AnimatorUpdateListener {
        C03132() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03121());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.addUpdateListener(new C03132());
