...
public class Toolbar extends ViewGroup {
    ...
    class C04021 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C04021() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C04031());
        int expandedMenuItemId;
        boolean isOverflowOpen;

        static class C04031 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C04031() {
            }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C04021();
