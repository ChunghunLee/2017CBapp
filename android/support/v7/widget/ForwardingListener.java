...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C02041 implements OnAttachStateChangeListener {
        C02041() {
        }
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C02041());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C02052());
    }
