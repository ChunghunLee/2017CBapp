...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C04042();
    ...
    class C04042 implements OnItemTouchListener {
        C04042() {
        }
    ...
    class C04055 implements ChildDrawingOrderCallback {
        C04055() {
        }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C04055();
            }
